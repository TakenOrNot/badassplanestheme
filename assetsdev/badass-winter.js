...
!function()
{
    ...
    class Badass2018ThemeWinter extends VanillaTheme
    {
        constructor() {
            super();
        ...
        injectTextures(files, textureInfo, flagTextureInfo, spriteInfo, textures,paf)
        {
            ...
            for(let i in files)
            {
                ...
                {
                    files[i] = "//raw.githubusercontent.com/TakenOrNot/badassplanestheme/master/assetsdev/winter/" + getFileName(files[i]);
                    //console.log("paf " + paf);
                }
            }
        }
  ...
  function toggleRed ( force ) {
    ...
    $.extend(Badass2018ThemeWinter, {
        themeName: "Badass Planes Theme Winter",
    ...
    SWAM.registerExtension({
        name: "Badass Planes Theme Extension WINTER Edition",
        id: "Badass2018winter",
        description: "Experimental",
        author: "xplay",
        version: "1.0.1",
        settingsProvider: createSettingsProvider(),
        themes: [ Badass2018ThemeWinter ]
    });
}();