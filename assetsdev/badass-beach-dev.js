...
!function()
{
    ...
    class Badass2018ThemeBeachDev extends VanillaTheme
    {
        constructor() {
            super();
  ...
  function toggleRed ( force ) {
    ...
    SWAM.registerExtension({
        name: "Badass Planes Theme Extension BEACH (Dev) Edition",
        id: "Badass2018beachdev",
        description: "Experimental",
        author: "xplay",
        version: "1.0.2",
        settingsProvider: createSettingsProvider(),
        themes: [ Badass2018ThemeBeachDev ]
    });
}();